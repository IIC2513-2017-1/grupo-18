...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { description: @bet.description, execution_date: @bet.execution_date } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { description: @bet.description, execution_date: @bet.execution_date } }
